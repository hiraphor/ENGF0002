...
print("1024 as 2 bytes, big endian:", b)
b = (1024).to_bytes(4, byteorder='big')
print("1024 as 4 bytes, big endian:", b)
b = (1024).to_bytes(4, byteorder='little')
print("1024 as 4 bytes, little endian:", b)
